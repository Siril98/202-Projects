...
// Templated Truck class that has implemented functions below under header prototypes
// Date: 5/11/2017
// Lab Section: 13
// E-Mail: psiril1@umbc.edu
// Description:
// Templated class that is populated from a proj5_truck file.
// Has the ability to build trucks and store items inside of it
// using the templated Tqueue. Not all functions are needed to be
// used due to different ways of implementing this class
